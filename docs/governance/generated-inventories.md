...
- `access_decisioning`: 27
- `assurance_and_audit`: 24
- `credential_issuance`: 59
- `delegation_and_scope`: 31
- `governance_recognition`: 81
- `policy_definition`: 51
- `registry_management`: 17
- `terminology_definition`: 333
- `verification_and_reliance`: 23
