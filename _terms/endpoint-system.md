...
## Concept Identity
- **Concept ID**: `urn:tig:concept:endpoint-system`
...
- **endpoint system** (`en`, `alternative`)
- **endpoint systems** (`en`, `alternative`)

## Legacy Aliases
endpoint system, endpoint systems

## Semantic Relations
- **related**: `urn:tig:concept:intermediary-system`
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/endpoint-system.md`
