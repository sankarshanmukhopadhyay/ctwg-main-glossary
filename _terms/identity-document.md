...
- **identity document** (`en`, `alternative`)
- **identity documents** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:identity-document`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/identity-document.md`
...
*Generated from `glossary/terms/identity-document.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
