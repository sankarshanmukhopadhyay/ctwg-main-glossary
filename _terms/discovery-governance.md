...
- **discovery-governance** (`en`, `alternative`)
...
### Semantic relations
- **related**: `urn:tig:concept:discovery`
...
- **Concept ID**: `urn:tig:concept:discovery-governance`
...
### Legacy aliases
discovery governance, discovery-governance
...
*Generated from `glossary/terms/discovery-governance.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
