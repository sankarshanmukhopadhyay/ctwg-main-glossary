...
- **Concept ID**: `urn:tig:concept:thing`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/thing.md`
...
*Generated from `glossary/terms/thing.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
