...
## Concept Identity
- **Concept ID**: `urn:tig:concept:trust-task`
...
- **trust task** (`en`, `alternative`)
- **trust tasks** (`en`, `alternative`)

## Legacy Aliases
trust task, trust tasks
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-task.md`
