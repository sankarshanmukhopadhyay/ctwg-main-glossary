...
- **certification authority** (`en`, `alternative`)
- **certification authorities** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:certification-authority`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/certification-authority.md`
...
*Generated from `glossary/terms/certification-authority.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
