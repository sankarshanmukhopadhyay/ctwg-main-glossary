...
A check intended to show that a person or device is present and responding now, rather than being a recording or replay.
...
- **liveness detection** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:liveness-detection`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/liveness-detection.md`
...
*Generated from `glossary/terms/liveness-detection.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
