...
> Generated file. Update `glossary/terms/term.yaml` and regenerate artifacts instead of editing this page directly.

# term

## Concept Identity
- **Concept ID**: `urn:tig:concept:term`
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/term.md`
...
## Notes
- A term MUST NOT be confused with the concept it refers to (which is an extremely common mistake).
