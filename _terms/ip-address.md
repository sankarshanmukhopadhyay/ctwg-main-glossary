...
- **IP address** (`en`, `alternative`)
- **IP addresses** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:ip-address`
...
*Generated from `glossary/terms/ip-address.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
