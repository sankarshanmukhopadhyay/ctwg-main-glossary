...
- **Concept ID**: `urn:tig:concept:non-transferable-identifier`
...
*Generated from `glossary/terms/non-transferable-identifier.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
