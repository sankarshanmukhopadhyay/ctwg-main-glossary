...
## Concept Identity
- **Concept ID**: `urn:tig:concept:contextual-linkability`
...
- **contextual linkability** (`en`, `alternative`)

## Legacy Aliases
contextual-linkability, contextual linkability
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/contextual-linkability.md`
