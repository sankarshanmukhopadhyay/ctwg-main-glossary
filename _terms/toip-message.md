...
## Concept Identity
- **Concept ID**: `urn:tig:concept:toip-message`
...
- **ToIP message** (`en`, `alternative`)
- **ToIP messages** (`en`, `alternative`)

## Legacy Aliases
ToIP message, ToIP messages
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/toip-message.md`
