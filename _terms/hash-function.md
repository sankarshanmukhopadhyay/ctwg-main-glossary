...
## Concept Identity
- **Concept ID**: `urn:tig:concept:hash-function`
...
- **hash function** (`en`, `alternative`)
- **hash functions** (`en`, `alternative`)
...
- [NIST-CSRC](https://csrc.nist.gov/glossary/term/hash_function).
