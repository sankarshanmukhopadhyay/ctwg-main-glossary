...
- **Concept ID**: `urn:tig:concept:binding`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/binding.md`
...
*Generated from `glossary/terms/binding.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
