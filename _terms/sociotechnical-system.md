...
- **sociotechnical system** (`en`, `alternative`)
- **sociotechnical systems** (`en`, `alternative`)
- **sociotechnical** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:sociotechnical-system`
...
### Legacy aliases
sociotechnical system, sociotechnical systems, sociotechnical
...
*Generated from `glossary/terms/sociotechnical-system.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
