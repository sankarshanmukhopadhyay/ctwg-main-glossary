...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/certification-body.md`
...
*Generated from `glossary/terms/certification-body.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
