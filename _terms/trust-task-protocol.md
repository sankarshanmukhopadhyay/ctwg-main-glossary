...
- **trust task protocol** (`en`, `alternative`)
- **trust task protocols** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:trust-task-protocol`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-task-protocol.md`

<details markdown="1">
<summary><strong>Implementation and governance metadata</strong></summary>

### Legacy aliases
trust task protocol, trust task protocols
...
*Generated from `glossary/terms/trust-task-protocol.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
