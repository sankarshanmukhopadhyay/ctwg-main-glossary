...
- **Concept ID**: `urn:tig:concept:node`
- **Editorial status**: `stable`
- **Provenance classification**: `locally_defined`
- **Source corpus**: Trust Infrastructure Glossary

### Standards and source references
- [Wikipedia](https://en.wikipedia.org/wiki/Node_\(networking\)).
...
*Generated from `glossary/terms/node.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
