...
> Generated file. Update `glossary/terms/public-key.yaml` and regenerate artifacts instead of editing this page directly.

# public-key

## Concept Identity
- **Concept ID**: `urn:tig:concept:public-key`
...
- **public key** (`en`, `alternative`)
- **public keys** (`en`, `alternative`)
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/public-key.md`
