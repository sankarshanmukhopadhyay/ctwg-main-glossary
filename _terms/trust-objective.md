...
- **trust objective** (`en`, `alternative`)
- **trust objectives** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:trust-objective`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-objective.md`

<details markdown="1">
<summary><strong>Implementation and governance metadata</strong></summary>

### Legacy aliases
trust objective, trust objectives
...
*Generated from `glossary/terms/trust-objective.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
