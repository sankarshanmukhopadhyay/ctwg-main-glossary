...
> Generated file. Update `glossary/terms/non-custodial-wallet.yaml` and regenerate artifacts instead of editing this page directly.

# non-custodial-wallet

## Concept Identity
- **Concept ID**: `urn:tig:concept:non-custodial-wallet`
...
- **non-custodial wallet** (`en`, `alternative`)
- **non-custodial wallets** (`en`, `alternative`)
