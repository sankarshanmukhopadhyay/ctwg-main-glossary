...
## Concept Identity
- **Concept ID**: `urn:tig:concept:federated-identity`
...
- **federated identity** (`en`, `alternative`)
- **federated identities** (`en`, `alternative`)

## Legacy Aliases
federated identity, federated identities

## Semantic Relations
- **related**: `urn:tig:concept:decentralized-identity`
- **related**: `urn:tig:concept:self-sovereign-identity`
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/federated-identity.md`
