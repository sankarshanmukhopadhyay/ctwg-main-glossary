...
- **trust boundary** (`en`, `alternative`)
- **trust boundaries** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:trust-boundary`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-boundary.md`
...
*Generated from `glossary/terms/trust-boundary.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
