...
## Concept Identity
- **Concept ID**: `urn:tig:concept:governance-diamond`
...
- **governance diamond** (`en`, `alternative`)
- **governance diamonds** (`en`, `alternative`)

## Legacy Aliases
governance diamond, governance diamonds
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/governance-diamond.md`
