...
- **Concept ID**: `urn:tig:concept:vc`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/vc.md`
...
*Generated from `glossary/terms/vc.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
