...
## Concept Identity
- **Concept ID**: `urn:tig:concept:toip-specification`
...
- **ToIP specification** (`en`, `alternative`)
- **ToIP specifications** (`en`, `alternative`)

## Legacy Aliases
ToIP specification, ToIP specifications
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/toip-specification.md`
