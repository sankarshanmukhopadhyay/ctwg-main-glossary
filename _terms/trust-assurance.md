...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-assurance.md`
...
*Generated from `glossary/terms/trust-assurance.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
