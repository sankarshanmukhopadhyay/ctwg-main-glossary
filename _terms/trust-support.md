...
## Concept Identity
- **Concept ID**: `urn:tig:concept:trust-support`
...
- **trust support** (`en`, `alternative`)
- **trust supports** (`en`, `alternative`)

## Legacy Aliases
trust support, trust supports
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-support.md`
