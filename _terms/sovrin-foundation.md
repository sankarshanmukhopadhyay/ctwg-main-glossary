...
- **Sovrin Foundation** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:sovrin-foundation`
...
*Generated from `glossary/terms/sovrin-foundation.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
