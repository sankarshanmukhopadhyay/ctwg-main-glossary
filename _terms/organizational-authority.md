...
- **organizational authority** (`en`, `alternative`)
- **organisational authority** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:organizational-authority`
...
*Generated from `glossary/terms/organizational-authority.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
