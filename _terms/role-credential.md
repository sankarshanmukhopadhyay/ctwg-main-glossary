...
- **role credential** (`en`, `alternative`)
- **role credentials** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:role-credential`
...
*Generated from `glossary/terms/role-credential.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
