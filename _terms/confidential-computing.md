...
## Concept Identity
- **Concept ID**: `urn:tig:concept:confidential-computing`
...
- **confidential computing** (`en`, `alternative`)
...
- [NIST-CSRC](https://csrc.nist.gov/glossary/term/confidential_computing).
