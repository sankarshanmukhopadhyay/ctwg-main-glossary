...
- **ToIP trust network** (`en`, `alternative`)
- **ToIP trust networks** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:toip-trust-network`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/toip-trust-network.md`

<details markdown="1">
<summary><strong>Implementation and governance metadata</strong></summary>

### Legacy aliases
ToIP trust network, ToIP trust networks
...
*Generated from `glossary/terms/toip-trust-network.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
