...
## Concept Identity
- **Concept ID**: `urn:tig:concept:credential-request`
...
- **credential request** (`en`, `alternative`)
- **credential requests** (`en`, `alternative`)

## Legacy Aliases
credential request, credential requests
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/credential-request.md`
