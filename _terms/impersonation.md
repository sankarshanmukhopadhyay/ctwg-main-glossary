...
## Concept Identity
- **Concept ID**: `urn:tig:concept:impersonation`
...
- **impersonate** (`en`, `alternative`)
- **impersonates** (`en`, `alternative`)
- **impersonated** (`en`, `alternative`)

## Legacy Aliases
impersonation, impersonate, impersonates, impersonated
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/impersonation.md`
