...
## Concept Identity
- **Concept ID**: `urn:tig:concept:vid-relationship`
...
- **VID relationship** (`en`, `alternative`)
- **VID relationships** (`en`, `alternative`)

## Legacy Aliases
VID relationship, VID relationships
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/vid-relationship.md`
