...
- **Concept ID**: `urn:tig:concept:self-certified`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/self-certified.md`
...
*Generated from `glossary/terms/self-certified.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
