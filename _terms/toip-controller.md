...
## Concept Identity
- **Concept ID**: `urn:tig:concept:toip-controller`
...
- **ToIP controller** (`en`, `alternative`)
- **ToIP controllers** (`en`, `alternative`)

## Legacy Aliases
ToIP controller, ToIP controllers
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/toip-controller.md`
