...
> Generated file. Update `glossary/terms/unicast.yaml` and regenerate artifacts instead of editing this page directly.

# unicast

## Concept Identity
- **Concept ID**: `urn:tig:concept:unicast`
...
## Semantic Relations
- **related**: `urn:tig:concept:anycast`
