...
- **holder binding** (`en`, `alternative`)
- **holder bindings** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:holder-binding`
...
*Generated from `glossary/terms/holder-binding.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
