...
## Concept Identity
- **Concept ID**: `urn:tig:concept:mobile-deep-link`
...
- **mobile deep link** (`en`, `alternative`)
- **mobile deep links** (`en`, `alternative`)
- **mobile deep linking** (`en`, `alternative`)

## Legacy Aliases
mobile deep link, mobile deep links, mobile deep linking
