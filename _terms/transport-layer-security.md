...
## Concept Identity
- **Concept ID**: `urn:tig:concept:transport-layer-security`
...
- **Transport Layer Security** (`en`, `alternative`)
...
## Notes
- TLS replaced the deprecated Secure Sockets Layer (SSL) protocol.
