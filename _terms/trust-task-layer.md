...
## Concept Identity
- **Concept ID**: `urn:tig:concept:trust-task-layer`
...
- **trust task layer** (`en`, `alternative`)
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-task-layer.md`
