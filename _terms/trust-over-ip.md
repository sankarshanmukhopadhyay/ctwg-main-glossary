...
- **Concept ID**: `urn:tig:concept:trust-over-ip`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/trust-over-ip.md`
...
*Generated from `glossary/terms/trust-over-ip.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
