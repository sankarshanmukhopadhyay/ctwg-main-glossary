...
- **persistent connection** (`en`, `alternative`)
- **persistent connections** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:persistent-connection`
...
*Generated from `glossary/terms/persistent-connection.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
