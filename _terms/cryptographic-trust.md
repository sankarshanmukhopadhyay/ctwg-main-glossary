...
## Concept Identity
- **Concept ID**: `urn:tig:concept:cryptographic-trust`
...
- **cryptographic trust** (`en`, `alternative`)
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/cryptographic-trust.md`
