...
## Concept Identity
- **Concept ID**: `urn:tig:concept:virtual-vault`
...
- **virtual vault** (`en`, `alternative`)
- **virtual vaults** (`en`, `alternative`)

## Legacy Aliases
virtual vault, virtual vaults
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/virtual-vault.md`
