...
## Concept Identity
- **Concept ID**: `urn:tig:concept:zero-trust-architecture`
...
- **zero-trust architecture** (`en`, `alternative`)
- **zero-trust architectures** (`en`, `alternative`)
- **ZTA** (`en`, `alternative`)
- **ZTAs** (`en`, `alternative`)

## Legacy Aliases
zero-trust architecture, zero-trust architectures, ZTA, ZTAs
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/zero-trust-architecture.md`
