...
## Concept Identity
- **Concept ID**: `urn:tig:concept:custodial-wallet`
...
- **custodial wallet** (`en`, `alternative`)
- **custodial wallets** (`en`, `alternative`)

## Legacy Aliases
custodial wallet, custodial wallets
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/custodial-wallet.md`
