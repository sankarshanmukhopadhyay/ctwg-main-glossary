...
- **machine-readability** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:machine-readable`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/machine-readable.md`
...
*Generated from `glossary/terms/machine-readable.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
