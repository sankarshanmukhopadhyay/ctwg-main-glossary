...
- **Concept ID**: `urn:tig:concept:c2pa`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/c2pa.md`
...
*Generated from `glossary/terms/c2pa.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
