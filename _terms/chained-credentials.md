...
- **chained credentials** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:chained-credentials`
...
*Generated from `glossary/terms/chained-credentials.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
