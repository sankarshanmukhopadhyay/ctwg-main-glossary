...
## Concept Identity
- **Concept ID**: `urn:tig:concept:multi-party-control`
...
- **multi-party control** (`en`, `alternative`)
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/multi-party-control.md`
