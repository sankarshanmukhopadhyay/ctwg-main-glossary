...
- **primary document** (`en`, `alternative`)
- **primary documents** (`en`, `alternative`)
...
- **Concept ID**: `urn:tig:concept:primary-document`
- **Editorial status**: `stable`
- **Provenance classification**: `adapted`
- **Source corpus**: Trust over IP Main Glossary

### Standards and source references
- ToIP CTWG maintained glossary source: `spec/terms-definitions/primary-document.md`

<details markdown="1">
<summary><strong>Implementation and governance metadata</strong></summary>

### Legacy aliases
primary document, primary documents
...
*Generated from `glossary/terms/primary-document.yaml`. Edit the source concept and regenerate rather than editing this page directly.*
