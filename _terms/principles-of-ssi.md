...
## Concept Identity
- **Concept ID**: `urn:tig:concept:principles-of-ssi`
...
- **Principles of SSI** (`en`, `alternative`)
...
- ToIP CTWG maintained glossary source: `spec/terms-definitions/principles-of-ssi.md`
