...
~ A [[ref: role]] an [[ref: agent]] performs to verify one or more [[ref: proofs]] of the [[ref: claims]] in a [[ref: digital credential]] or other [[ref: verifiable data]], and to evaluate whether the presented material satisfies applicable verification and policy criteria.

~ Note: A verifier may function as an execution-time decision point because verification outcomes can determine whether access, acceptance, recognition, or reliance is granted.
